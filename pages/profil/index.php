...
<section>
	...
	<!-- end portfolio section include -->
	<!-- exam result section include -->
		<!-- include style.css -->
...
<section>
	...
	<!-- end exam result section include -->
	<!-- articles section include -->
		<section>
	<div class="container">
		<div class="section-header">
			<div class="section-title">
	...
	<!-- end acticlec section include -->
	<!-- certificate section include -->
<section>
	<div class="container">
		<div class="section-header">
			<div class="section-title">
